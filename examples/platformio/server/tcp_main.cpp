/**
 * @file tcp_main.cpp
 * @brief EZModbus TCP Server demonstration showing all Word registration methods
...
ModbusServer server(interface, wordStore);
...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println("\nEZModbus TCP Server - Word Registration Demo");
